...
const setDueDate = () => {
  ...
  const addOneWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date, 7);
  const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(addOneWeek, "yyyy-MM-dd");
  return dueDate;
};
// declare variables :
const allProjects = [];
...
function addNewtask() {
  if (
    ...
    return;
  const newTask = new _tasks_js__WEBPACK_IMPORTED_MODULE_1__["default"](formTitle.value, formDetails.value, setDueDate());
...
const UI = {
  ...
  deleteSideBarElement: function (projectDeletebutton) {
    ...
    projectDeletebutton.onclick = () => {
      ...
      _storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].deleteCurrentStorageProject(projectName);
    };
  },
  ...
  deleteTask: function (deleteTaskButton, task) {
    ...
    deleteTaskButton.onclick = function () {
      // getSelectedProject(projectName);
      taskElement.remove();
      _storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].deleteCurrentStorageTasks(task);
      deleteCurrentTask();
    };
  },
  // checkbox event :
...
sidebarAddButton.addEventListener("click", function () {
  ...
  _storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].setAllProjects(allProjects);
});
...
// storage UI Elements :
const storageUI = {
  storageProjects: _storage_js__WEBPACK_IMPORTED_MODULE_2__["default"].getAllProjects(),
