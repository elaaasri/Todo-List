...
const setDueDate = () => {
  ...
  const addOneWeek = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date, 7);
  const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(addOneWeek, "yyyy-MM-dd");
  return dueDate;
};
// declare variables :
const allProjects = [];
